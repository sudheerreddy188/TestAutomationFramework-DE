...
public class SitTaxModule extends WebDriverFactory{
	...
	*/
	...
	@Test
	public void sitTaxSelTc1() throws InterruptedException { 
	    loc_driver.get().get("https://www.google.com/");
	    System.out.println("I ran sitTaxSelTc1 .! ");
	    Thread.sleep(3000);
	}
	
	@Test
	public void sitTaxSelTc2() throws InterruptedException { 
	    loc_driver.get().get("https://www.amazon.co.uk/");
	    System.out.println("I ran sitTaxSelTc2 .! ");
	    Thread.sleep(3000);
	}
	
	@Test
	public void sitTaxSelTc3() throws InterruptedException { 
	    loc_driver.get().get("https://github.com/");
	    System.out.println("I ran sitTaxSelTc3 .! ");
	    Thread.sleep(3000);
	}
